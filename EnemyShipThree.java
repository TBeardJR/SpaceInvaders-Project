...
import java.awt.*;
/**
 * Write a description of class EnemyShipThree here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class EnemyShipThree extends EnemyShip
{
    ...
    public EnemyShipThree(Actor target)
    {
        super(target);
        setHealth(30);
    ...
    {        
        if(isInWorld == true)
        {
            ...
            {
                shootAtTarget("GreenLaserBeam", getGunReloadTime());
