 ...
 * LVL 7
 */
public class WorldSeven extends WorldControl
{
    //The chances that an enemy ship can spawn. The higher the number the better chance an enemy ship has of spawning
    public static final int ENEMY_ONE_CHANCE = 40;
    public static final int ENEMY_TWO_CHANCE = 15;
    public static final int ENEMY_THREE_CHANCE = 70;
    public static final int ENEMY_FOUR_CHANCE = 85;
    public static final int ENEMY_FIVE_CHANCE = 60;
