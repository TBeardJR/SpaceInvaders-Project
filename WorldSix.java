 ...
 * @author Group 10 
 */
public class WorldSix extends WorldControl
{
    //The chances that an enemy ship can spawn. The higher the number the better chance an enemy ship has of spawning
    public static final int ENEMY_ONE_CHANCE = 50;
    public static final int ENEMY_TWO_CHANCE = 10;
    public static final int ENEMY_THREE_CHANCE = 80;
    public static final int ENEMY_FOUR_CHANCE = 80;
    public static final int ENEMY_FIVE_CHANCE = 50;
    ...
    public WorldSix() 
    {
        ...
        //Add rocket's health status to it's last known position before the world switched
