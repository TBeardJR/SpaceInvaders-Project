 ...
 * @author Group 10 
 */
public class WorldThree extends WorldControl
{
    //The chances that an enemy ship can spawn. The higher the number the better chance an enemy ship has of spawning
    public static final int ENEMY_ONE_CHANCE = 95;
    public static final int ENEMY_TWO_CHANCE = 0;
    public static final int ENEMY_THREE_CHANCE = 85;
    public static final int ENEMY_FOUR_CHANCE = 60;
